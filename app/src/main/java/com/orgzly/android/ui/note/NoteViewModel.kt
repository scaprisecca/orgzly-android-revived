...
class NoteViewModel(
    ...
    private val initialPayload = initialData.payload
    ...
    fun loadData() {
        App.EXECUTORS.diskIO().execute {
            ...
            notePayload = if (isNew()) {
                initialPayload ?: NoteBuilder.newPayload(App.getAppContext(), title.orEmpty(), content)
            } else {
    ...
    fun hasInitialTitleData(): Boolean {
        return !TextUtils.isEmpty(initialData.payload?.title ?: initialData.title)
    }
